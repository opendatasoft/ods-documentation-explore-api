...
```http
GET http://public.opendatasoft.com/api/odata/$metadata
```
...
```http
GET http://public.opendatasoft.com/api/odata/error?$format=json
```
...
```http
GET http://public.opendatasoft.com/api/odata/error?$format=xml
```
...
```http
GET http://public.opendatasoft.com/api/odata/?$format=json
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$top=2
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$skip=1&$top=2
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$search=Cad
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$filter=name eq Caden
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$filter=number gt 280 and not number ge 285
```
...
```http
GET <http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$filter=number lt 8&$top=1&$count=true
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013/$count
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$search=Cad&$orderby=number
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$search=Cad&$orderby=number desc
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013(efc3e55da1dd591ba0c2bd42f0b0719e330f738f)
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013?$search=Cad&$select=name, number
```
...
```http
GET http://public.opendatasoft.com/api/odata/baby_names_nc_2013(efc3e55da1dd591ba0c2bd42f0b0719e330f738f)?$select=name
```
